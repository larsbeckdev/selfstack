...
// Figma-style color picker panel adapted from shadcn-form registry
// (https://www.shadcn-form.com/registry/color-picker.json)
// Provides a 2D saturation/value plane, hue + alpha sliders, format switcher,
// EyeDropper API, and a row of swatches. Returns a hex/hexa string.
...
export function ColorPickerPanel({
  ...
  return (
    <div
      className={[
        "w-full max-w-[320px] space-y-3 rounded-xl border bg-background p-3 shadow-sm",
        className,
      ]
        .filter(Boolean)
        .join(" ")}>
