...
import { canViewAllBoards, canViewBoards } from "@/lib/permissions";
...
export default async function AppLayout({
  ...
  // on "my" boards. Editors only see org boards of orgs they actually
  // belong to (no implicit access just because of the global role).
